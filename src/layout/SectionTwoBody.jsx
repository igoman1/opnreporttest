...
const SectionTwoBody = (props) => {
    ...
    return (
        <div className='section-body'>
            ...
            최근 3년 추세는 {data['3y_trend_profit_per_area_start_year']} 월 {data['3y_trend_profit_per_area_start_market_size']}에서 {data['3y_trend_profit_per_area_end_year']} 월 {data['3y_trend_profit_per_area_end_market_size']}으로 {data['3y_trend_profit_per_area_end_percent']} {data.profit_per_area_trend}하였습니다.           </Card>
        </div>
    );
};
